...
import com.trust.walletclone.databinding.DialogNotificationBinding
...
class NotificationDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = DialogNotificationBinding.inflate(inflater)
        initView()
        return binding.root
    }

    private fun initView() {
        binding.toolbar.title.text = getString(R.string.lbl_notification)
